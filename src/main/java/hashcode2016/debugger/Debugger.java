package hashcode2016.debugger;

import hashcode2016.framework.Point2D;
import hashcode2016.framework.Ticker;
import hashcode2016.framework.TurnListener;
...
import hashcode2016.Loader;
import hashcode2016.Order;
import hashcode2016.Player;
import hashcode2016.Simulation;
import hashcode2016.Theme;
import hashcode2016.Warehouse;
import hashcode2016.players.DummyPlayer;
import hashcode2016.players.NearestOrdersPlayer;
import hashcode2016.players.PasoDoblePlayer;

public class Debugger extends Application implements Ticker, TurnListener {

    public static void main(String... args) {
        launch(Debugger.class, args);
    }
    ...
    private void start() {
        ...
        Thread simulationThread = new Thread(() -> {
            try {
                ...
                simulation.setTicker(Debugger.this);
                simulation.addTurnListener(Debugger.this);
                simulation.start();
            } catch (Exception e) {
